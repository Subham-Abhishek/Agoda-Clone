...
import {
  ...
  searchDataRequest,
  searchDataSuccess,
} from "../../Redux/Bookingredux/action";
...
const Dashboard = () => {
  ...
  const searchData = () => {
    ...
    return axios
      .get(
        `https://agoda-api.herokuapp.com/hotel?city=${searchedCity.toLowerCase()}`
      )
      .then((res) => {
                  ...
                  <div className={styles.imgText}>
                    ...
                    <div className={styles.upgradetext}>
                      <h5 className={styles.upgradetext1}>
                        Agoda Special Offers <br /> Upgrade your experience with
                        Agoda Special Offers Hurry
                      </h5>
                    </div>
                  </div>
