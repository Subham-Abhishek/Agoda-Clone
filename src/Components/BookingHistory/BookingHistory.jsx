    ...
    return (
        ...
        <div className="saved">
            ...
            {book?<div className="Nothing">
                ...
                <p>
                Just click on the heart icon on any property’s page and you’ll save it here for easy reference later.
                </p>
                  <Link to="/">
            ...
            <div className="booking-holder">
                <div className="hotelcard">
                   ...
                   <div className="options">
                       <button className="Continue1" onClick={handleClickOpen}>Cancel booking</button>
                   </div>
                </div>
            </div>}
